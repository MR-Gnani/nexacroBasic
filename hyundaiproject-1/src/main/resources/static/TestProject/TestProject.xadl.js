(function()
{
    return function()
    {
        ...
        this.on_initApplication = function()
        {
            ...
            // frame
            var mainframe = this.createMainFrame("mainframe", "absolute", "0", "0", "1200", "960", null, null, this);
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::MenuList.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::MenuList.xfdl");
